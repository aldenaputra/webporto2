        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#education" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Education
                </a>
              </li>
              <li>
                <a href="#workexperience" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Experience
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                alden.aputra@gmail.com
              </a>
              <div className="flex space-x-4">
                <a 
                  href="https://github.com/aldenaputra" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.linkedin.com/in/aldenaputra/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition-colors"
                  aria-label="LinkedIn"
